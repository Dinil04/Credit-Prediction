...
def Select_Option():
    ...
    header = ['Progress', 'Trailer', 'Retriver', 'Exclude']
    print(' '.join(header))
    for x in range(max(Progress_Count, Trailer_Count, Retriver_Count, Exclude_Count)):
      print(" {0}     {1}     {2}     {3}".format(
        '*' if x < Progress_Count else ' ',
        '*' if x < Trailer_Count else ' ',
        '*' if x < Retriver_Count else ' ',
    ...
    print ('\n Progress - ',Pr_list[0],',',Pr_list[1],',', Pr_list[2])
    print ('\n Progress (Module Trailer) - ',Trai_list[0],',',Trai_list[1],',', Trai_list[2])
    print ('\n Module Retriver - ',Ret_list[0],',',Ret_list[1],',', Ret_list[2])
    print ('\n Exclude - ',Exclu_list[0],',',Exclu_list[1],',', Exclu_list[2]) 
